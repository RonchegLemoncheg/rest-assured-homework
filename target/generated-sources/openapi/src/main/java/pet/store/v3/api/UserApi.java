...
package pet.store.v3.api;

import java.time.OffsetDateTime;
import pet.store.v3.model.User;
...
public class UserApi {
     ...
     * This can only be done by the logged in user.
     *
     * @see #usernamePath name that needs to be updated (required)
    ...
    public static class UpdateUserOper implements Oper {
        ...
        /**
         * @param username (String) name that needs to be updated (required)
         * @return operation
         */
