    ...
    extends OpenAttrs
{
    ...
    public Redefine withAnnotationOrSimpleTypeOrComplexType(OpenAttrs... values) {
        if (values!= null) {
            for (OpenAttrs value: values) {
                getAnnotationOrSimpleTypeOrComplexType().add(value);
            }
        }
        return this;
    }

    public Redefine withAnnotationOrSimpleTypeOrComplexType(Collection<OpenAttrs> values) {
        if (values!= null) {
            getAnnotationOrSimpleTypeOrComplexType().addAll(values);
        }
        return this;
    }

    public Redefine withSchemaLocation(String value) {
        setSchemaLocation(value);
        return this;
    }

    public Redefine withId(String value) {
        setId(value);
        return this;
    }
