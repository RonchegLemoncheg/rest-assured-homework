    ...
    extends Annotated
{
    ...
    public Restriction withSimpleType(LocalSimpleType value) {
        setSimpleType(value);
        return this;
    }

    public Restriction withFacets(Object... values) {
        if (values!= null) {
    ...
    public Restriction withFacets(Collection<Object> values) {
        if (values!= null) {
    ...
    public Restriction withBase(QName value) {
        setBase(value);
        return this;
    }

    @Override
    public Restriction withAnnotation(Annotation value) {
        setAnnotation(value);
        return this;
    }

    @Override
    public Restriction withId(String value) {
        setId(value);
        return this;
    }
