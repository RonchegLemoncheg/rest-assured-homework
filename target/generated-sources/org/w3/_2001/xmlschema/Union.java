    ...
    extends Annotated
{
    ...
    public Union withSimpleType(LocalSimpleType... values) {
        if (values!= null) {
            for (LocalSimpleType value: values) {
                getSimpleType().add(value);
            }
        }
        return this;
    }

    public Union withSimpleType(Collection<LocalSimpleType> values) {
        if (values!= null) {
            getSimpleType().addAll(values);
        }
        return this;
    }

    public Union withMemberTypes(QName... values) {
        if (values!= null) {
            for (QName value: values) {
                getMemberTypes().add(value);
            }
        }
        return this;
    }

    public Union withMemberTypes(Collection<QName> values) {
        if (values!= null) {
            getMemberTypes().addAll(values);
        }
        return this;
    }

    @Override
    public Union withAnnotation(Annotation value) {
        setAnnotation(value);
        return this;
    }

    @Override
    public Union withId(String value) {
        setId(value);
        return this;
    }
