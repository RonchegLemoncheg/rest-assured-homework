    ...
    extends Annotated
{
    ...
    public Wildcard withNamespace(String... values) {
        if (values!= null) {
            for (String value: values) {
                getNamespace().add(value);
            }
        }
        return this;
    }

    public Wildcard withNamespace(Collection<String> values) {
        if (values!= null) {
            getNamespace().addAll(values);
        }
        return this;
    }

    public Wildcard withProcessContents(String value) {
        setProcessContents(value);
        return this;
    }

    @Override
    public Wildcard withAnnotation(Annotation value) {
        setAnnotation(value);
        return this;
    }

    @Override
    public Wildcard withId(String value) {
        setId(value);
        return this;
    }
