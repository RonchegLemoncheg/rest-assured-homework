...
public abstract class AbstractOrderAssert<S extends AbstractOrderAssert<S, A>, A extends Order> extends AbstractObjectAssert<S, A> {
   ...
   */
  public S hasShipDate(java.time.OffsetDateTime shipDate) {
    // check that actual Order we want to make assertions on is not null.
    isNotNull();
    ...
    // null safe check
    java.time.OffsetDateTime actualShipDate = actual.getShipDate();
   ...
   */
  public S hasStatus(Order.StatusEnum status) {
    // check that actual Order we want to make assertions on is not null.
    isNotNull();
    ...
    // null safe check
    Order.StatusEnum actualStatus = actual.getStatus();
